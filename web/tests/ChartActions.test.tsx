...
// Calcular una carta no gasta nada: lo que se lee se elige acá, apretando. La
// carta nunca pide una lectura sola al montarse.
describe("al llegar a la carta", () => {
  it("ningún pedido al montar: la lectura se pide con el botón", async () => {
    const fetchMock = vi.fn();
    vi.stubGlobal("fetch", fetchMock);
